    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-white/10 max-w-md w-full p-6 rounded-xl shadow-lg text-center mx-4">
        ...
        <p className="text-sm mb-4">
          {i18n.cookieBanner.TEXT_2} <a href={cookiesPage} className='text-[#0C3956] hover:text-[#151f2b] underline'>{i18n.cookieBanner.TEXT_3}</a>
        </p>
        <div className="flex justify-center gap-4">
          <button
            onClick={acceptCookies}
            className="px-4 py-2 rounded cursor-pointer bg-[#0C3956] hover:bg-[#061B29] text-white font-semibold transition-all duration-300"
          >
